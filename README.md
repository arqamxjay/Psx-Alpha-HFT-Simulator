<img width="748" height="458" alt="Screenshot 2026-01-21 at 2 29 27 PM" src="https://github.com/user-attachments/assets/4258e179-3258-4119-9b7c-892663bab722" />
...
Limit Order Book (LOB) using `std::map` and `std::vector`.
